ActionController::Routing::Routes.draw do |map|
  ...
  map.resources :list_headers, :collection => {:add_merge => :post, :add_exclude => :post, :manage_list => :get, :compile_list => :get, :org_manage_list => :get, :org_compile_list => :get, :manager =>:get, :page_initial => :get}, :member => {:copy => :get, :delete_details => :put}
