...
#      @login_account_1 = Factory.build(:login_account, :person_id => @person.id, :password => "postpassword")
#      @login_account_1.save.should == true
#      @login_account_2 = Factory.build(:login_account, :person_id => @person.id, :password => "postpassword")
...
#    end
    ...
    it "should be invalid without a unique username" do
      @login_account_1 = Factory.build(:login_account, :user_name => "UserName", :password => "passpassword")
      @login_account_1.save.should == true
      @login_account_2 = Factory.build(:login_account, :user_name => "UserName",  :password => "passpassword")
      @login_account_2.save.should == false
