...
describe Tag do
  ...
  before(:each) do
    @attributes = Factory.attributes_for(:master_doc_type)
    @amazon_setting = Factory.build(:master_doc_type)
  end
  ...
  describe "When validating the model" do
    ...
    it "should not save when setting name is blank" do
      @amazon_setting = Factory.build(:master_doc_type, :name => "")
    ...
    it "should not save when setting name is existing for the same type" do
      ...
      @amazon_setting2 = Factory.build(:master_doc_type, :name => "Name")
      @amazon_setting.save.should == true
  ...
  describe "getter" do
    it "should return a string of options" do
      @amazon_setting = Factory(:master_doc_type)
