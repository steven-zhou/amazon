...
DuplicationFormulaDetail.create :duplication_formula_id => odf.id, :table_name => "organisations", :field_name => "full_name", :number_of_charecter => 10
DuplicationFormulaDetail.create :duplication_formula_id => odf.id, :table_name => "organisations", :field_name => "trade_as", :number_of_charecter => 10
DuplicationFormulaDetail.create :duplication_formula_id => odf.id, :table_name => "organisations", :field_name => "registered_name", :number_of_charecter => 10
