...
SecurityQuestion.create :name => "what is your favorite pet name", :status => true,:to_be_removed =>false
SecurityQuestion.create :name => "what is your father's name", :status => true,:to_be_removed =>false
SecurityQuestion.create :name => "what is your mather's name", :status => true,:to_be_removed =>false
...
ReceiptMethodType.create(:name => "Cash", :status => true,:to_be_removed =>false)
ReceiptMethodType.create(:name => "Cheque", :status => true,:to_be_removed =>false)
ReceiptMethodType.create(:name => "Money Order", :status => true,:to_be_removed =>false)
ReceiptMethodType.create(:name => "Credit Card", :status => true,:to_be_removed =>false)
ReceiptMethodType.create(:name => "Direct Credit", :status => true,:to_be_removed =>false)
ReceiptMethodType.create(:name => "Direct Debit", :status => true,:to_be_removed =>false)
ReceiptMethodType.create(:name => "Credit Journal", :status => true,:to_be_removed =>false)
ReceiptMethodType.create(:name => "Debit Journal", :status => true,:to_be_removed =>false)
