...
ReceiptAccountType.create(:name => "Membership", :status => true)
ReceiptAccountType.create(:name => "Donation", :status => true)
ReceiptAccountType.create(:name => "Sundry", :status => true)
ReceiptAccountType.create(:name => "Miscellaneous", :status => true)
ReceiptMethodType.create(:name => "Cash", :status => true)
ReceiptMethodType.create(:name => "Cheque", :status => true)
ReceiptMethodType.create(:name => "Money Order", :status => true)
ReceiptMethodType.create(:name => "Credit Card", :status => true)
ReceiptMethodType.create(:name => "Direct Credit", :status => true)
ReceiptMethodType.create(:name => "Direct Debit", :status => true)
ReceiptMethodType.create(:name => "Credit Journal", :status => true)
ReceiptMethodType.create(:name => "Debit Journal", :status => true)
AccountPurpose.create(:name => "Payroll", :status => true)
AccountPurpose.create(:name => "Donation", :status => true)
AccountPurpose.create(:name => "Membership Fees", :status => true)
AccountPurpose.create(:name => "General", :status => true)
AccountType.create(:name => "Savings", :status => true)
AccountType.create(:name => "Cheque", :status => true)
LinkModule.create(:name => "Membership", :status => true)
