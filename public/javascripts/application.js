...
// check change email , new email and repeat email is the same or not

//check_change_email = function()
//{
//  if($('#new_email').val()==$('#retype_new_email').val())
//      {
//
//          return true;
//      }
//      else
//          {
//               $('#error_message_text').html("New Email and Repeat New Email Must Same ");
//            $('#error_message_image').css("display","");
//            $('#error_message').dialog({
//                modal: true,
//                resizable: false,
...
//$(function(){
//    $("#retype_new_email").live('change', function(){
//        if ($(this).val()!= $('#new_email').val()){
//            $('#new_email').val('');
//            $(this).val('');
//            $('#change_email_submit').attr('disabled',true);
//            $('#error_message_text').html("Two Email are not matched ");
//
//            $('#error_message').dialog( {
//                modal: true,
//                resizable: true,
