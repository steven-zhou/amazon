...
$(document).ready(function() {
    ...
    $("div#module_menu").hover( function() {}, function() {
        $("div#module_menu_items").fadeOut("fast"),$("div#module_menu_top").removeClass("hover","fast");
    });
    $("div#module_menu_items li").hover(
        function(){
            $(this).addClass("hover","fast"); return false;
        },
        function(){
            $(this).removeClass("hover", "normal");return false;
        }
        );
});