...
class LoginAccount < ActiveRecord::Base
  ...
  validates_uniqueness_of :security_email
   ...
   validates_presence_of :security_question1_id, :message => "you must select three security questions.", :on => :update
  validates_presence_of :security_question2_id, :message => "you must select three security questions.", :on => :update
  validates_presence_of :security_question3_id, :message => "you must select three security questions.", :on => :update
