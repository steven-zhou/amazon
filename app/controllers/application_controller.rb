...
class ApplicationController < ActionController::Base
  ...
  def convert_html_to_pdf(folder, html_name, pdf_name, pdf_options={})
    ...
    pdf_options[:footer] ||= "--footer-html /temp/default-footer.html"
 
    system "wkhtmltopdf #{ @file_dir}/#{html_name}.html #{@file_dir}/#{pdf_name}.pdf #{pdf_options[:option]+" "+pdf_options[:header]+" "+pdf_options[:footer]}"
  end
