...
class ApplicationController < ActionController::Base
  ...
  def convert_html_to_pdf(folder, html_name, pdf_name, pdf_options={})
    ...
    pdf_options['default_option'] ||= "--page-size A4 --header-center EmZee --header-right 'Page [page] of [toPage]' --footer-center 'Copyright EmZee Pty Ltd - Generated at #{now}'"
    pdf_options['header'] ||= "--header-html public/temp/default-header.html"
    pdf_options['footer'] ||= "--footer-html public/temp/default-footer.html"
