...
robert_tingle_login = SystemUser.create(
  ...
  :security_question1 => "what is your name",
  :security_question2 => "what is your pet's name",
  :security_question3 => "what is your girlfriend name",
  :question1_answer => "1",
  :question2_answer => "2",
  :question3_answer => "3",
...
permission = GroupPermission.create(:system_permission_type_id => SystemPermissionType.first, :user_group_id => admin.id)
